...
import 'package:local/src/pages/image/review_2.dart';
            ...
            child: Row(
              children: const [
                Icon(Icons.settings_backup_restore,
                    color: Color(0xff404040), size: 30),
                Text(
                  '  다시 보기',
                  style: TextStyle(
                      fontSize: 24,
          ...
          child: Row(
            ...
            children: [
              ...
              Align(
                ...
                child: Row(
                  children: [
                    Icon(Icons.view_agenda, color: Color(0xffFFFFFF), size: 20),
                    IconButton(
                        padding: EdgeInsets.zero,
            ...
            child: Stack(children: [
              ...
              ListView(children: [
                ...
                Container(
                    ...
                    child:
                        Image.asset('assets/kitty.png', fit: BoxFit.contain)),
                Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(width: 10, color: Color(0xffEEEAFF)),
                    ...
                    child:
                        Image.asset('assets/heart.jpg', fit: BoxFit.contain)),
              ]),
            ]),
          ),
        ),
