...
import 'package:local/src/pages/profile/modify.dart';
import 'package:local/src/pages/profile/pwmodify.dart';
      ...
      children: [
        Expanded(
          child: SizedBox(
              height: 180,
              child: Container(
                decoration: BoxDecoration(color: Color(0xffE3DCFF)),
              )),
        ),
        Expanded(
          child: SizedBox(
              ...
              onPressed: () {
                showModalBottomSheet(
                  ...
                  builder: (BuildContext context) {
                    return Container(
                      height:
                          MediaQuery.of(context).size.height * 0.3, // 모달 높이 크기
